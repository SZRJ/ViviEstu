...
public class PreferenciasService {
    ...
    public ResponseEntity<Preferencia> obtenerPorId(Long id) {
    ...
    public Preferencia crearPreferencia(Preferencia preferencias) {
        return preferenciasRepository.save(preferencias);
    }

    // Actualizar preferencia existente
    public ResponseEntity<Preferencia> actualizarPreferencias(Long id, Preferencia nuevasPreferencias) {
        return preferenciasRepository.findById(id)
                .map(existentes -> {
                    ...
                    Preferencia actualizadas = preferenciasRepository.save(existentes);
